...
// Assuming motorcyclesRaw structure:
// {
//   [make: string]: {
//     [model: string]: string[]; // years as strings
//   }
// };

type MotorcycleData = {
  [make: string]: {
    [model: string]: string[]; // years array as strings
  };
};
...
export default function LoginPage() {
  ...
  // Initialize years from all years in motorcycles data
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    // Filter makes that have selected year
